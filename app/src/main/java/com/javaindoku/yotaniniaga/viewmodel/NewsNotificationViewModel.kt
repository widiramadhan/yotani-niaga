...
import com.javaindoku.yotaniniaga.repository.notification.newsnotification.NewsNotificationRepository
import com.javaindoku.yotaniniaga.service.network.ApiResult
import javax.inject.Inject

class NewsNotificationViewModel @Inject constructor(private val repository: NewsNotificationRepository) : BaseViewModel() {
