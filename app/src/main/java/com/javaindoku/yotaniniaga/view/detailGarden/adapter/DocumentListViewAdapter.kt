...
class DocumentListViewAdapter(
    var context: Context,
    var documentList: List<DocumentGarden>,
    var actionListener: ActionListener
) : RecyclerView.Adapter<DocumentListViewAdapter.ViewHolder>() {
    ...
    class ViewHolder(var binding: ItemDocumentGardenViewBinding, var actionListener: ActionListener, var context: Context) : RecyclerView.ViewHolder(binding.root) {
        fun bindView(
            ...
            CustomProfile.showRemoteImageUsingGlide(context, binding.imgDocument, documentGarden.foto.toString(), R.drawable.bg_rectangle_white_black)
